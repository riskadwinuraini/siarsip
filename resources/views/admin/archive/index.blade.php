                        ...
                        <tbody>
                          @foreach ($typeFiles as $item)
                              <tr>
                                ...
                                <td>{{ $item->name }}</td>
                                <td>
                                  <a href="{{ route('admin.jenis-pppk.edit', $item->id) }}" class="btn btn-info" style="display: inline-block; margin-right: 5px;">Edit</a>
                                  <form action="{{ route('admin.jenis-pppk.destroy', $item->id) }}" method="POST" style="display: inline-block;">
                                      @csrf
                                      @method('DELETE')
